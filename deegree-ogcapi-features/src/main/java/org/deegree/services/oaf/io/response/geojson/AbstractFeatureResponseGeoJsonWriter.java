...
public abstract class AbstractFeatureResponseGeoJsonWriter<T extends AbstractFeatureResponse>
	...
	@Override
	public long getSize(T features, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
	...
	protected void writeLinks(List<Link> links, GeoJsonWriter writer) throws IOException {
	...
	private void writeLink(GeoJsonWriter writer, Link link) throws IOException {
	...
	protected void writeCrs(String crs, GeoJsonWriter writer) throws IOException {
		if (crs != null)
